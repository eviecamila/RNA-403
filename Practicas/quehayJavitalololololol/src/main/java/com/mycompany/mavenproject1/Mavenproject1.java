...
//                    Red Hopfield
                    hopfield();
                case 2 ->
//                    App de escritorio para entrenar una Red Neuronal
                    applet();
                case 3 ->
//                    XOR con entrenamiento de propagacion
                    XOR.main(args, scanner);
                case 4 ->
//                    XOR con entranamiento natural
                    GeneticXOR.main(args, scanner);
                case 5 ->
//                    XOR con entrenamiento simulado
                    AnnealXOR.main(args, scanner);
                case 6 -> {
//                    Ejemplo de salida de Las muestras financieras
