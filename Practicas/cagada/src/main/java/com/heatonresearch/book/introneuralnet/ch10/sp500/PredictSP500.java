 ...
 *
 * PredictSP500: Attempt to predict the SP500 using a predictive feedforward
 * neural network. The key word is "attempt". The neural network can guess some
 * basic trends in the SP500, and is meant only as a starting point.
 *
...
public class PredictSP500 {
    ...
    public final String PATH = "C:\\Users\\pegro\\OneDrive\\Documentos\\GitHub\\RNA-403\\Practicas\\cagada\\src\\";
    ...
    public void loadNeuralNetwork() throws IOException, ClassNotFoundException {
        this.network = (FeedforwardNetwork) SerializeObject.load(this.PATH + "sp500.net");
    }
